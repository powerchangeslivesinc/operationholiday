      ...
      <header>
        <div
          ...
          style={{
            ...
            url('/assets/images/applicants/trees-bg-header-applicants.webp')`,
        ...
        <div className="mx-auto w-3/4">
          <div className="mx-auto pt-6 px-4">
            <p className="mb-6 text-sm md:text-base">
              ...
              personalized wish lists and anonymous “adoptions,” donors provide
              gifts and essentials that truly meet each household’s
            ...
            <h5 className="text-lg font-semibold">
              We will accept up to 150 eligible, approved applicants statewide.
              This opportunity is open to all New Jersey residents in every
              county, including:
            </h5>
            ...
            <ul className="mt-3 pl-4 space-y-1 list-none">
              ...
              <li className="-indent-4">✔️ People experiencing homelessness</li>
            ...
            <p className="mb-6 text-sm md:text-base">
              ...
              cards to stores.
              <br />
              <strong>❌ Prohibited items:</strong> cash and jewelry. Please be
              specific about sizes, colors, and meaningful preferences so donors
              can shop accurately.
            </p>
            <hr className="border-gray-300 my-6" />
            ...
            <p className="mb-6 text-sm md:text-base">
              Along with your wish list, include a brief, heartfelt explanation
              of{" "}
              <strong>
                why you or your family should be chosen to be adopted this
                Christmas.
              </strong>{" "}
              This story is shared with potential donors to help them understand
              your situation and give with compassion.
            </p>
            <hr className="border-gray-300 my-6" />
            ...
            <p className="mb-4 text-sm md:text-base">
              ...
              masked for privacy). On our site, your Family ID will display with
              a <strong>Christmas gift-box icon</strong>. When clicked, it will
              reveal:
            </p>
            ...
            <h4 className="text-xl font-semibold mb-2">Deadline & Selection</h4>
            <p className="mb-4 text-sm md:text-base">
              Applications are due by{" "}
              <strong>October 31, 2025 at 11:59 PM</strong>, or{" "}
              <strong>earlier if 150 applications are accepted</strong>, unless
              we extend the deadline. Submission does not guarantee selection;
              we reserve the right to determine eligibility and may contact you
              for clarification.
            </p>
